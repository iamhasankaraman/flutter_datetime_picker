...
class DatePicker {
  ...
  static Future<DateTime?> showDatePicker(
    ...
    datetime_picker.DatePickerTheme? theme,
  }) async {
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? datetime_picker.DatePickerTheme(),
  ...
  final datetime_picker.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    datetime_picker.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(datetime_picker.DatePickerTheme theme) {
  ...
  Widget _renderItemView(datetime_picker.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(datetime_picker.DatePickerTheme theme) {
